...
def build_dataset():
    ...
    trainset = torchvision.datasets.CIFAR10(root='/home/gaoshuai/Desktop/cs231n/data/', train=True, download=True,
                                            transform=transform_train)
    train_loader = torch.utils.data.DataLoader(trainset, batch_size=128, shuffle=True,
                                               num_workers=2)

    testset = torchvision.datasets.CIFAR10(root='/home/gaoshuai/Desktop/cs231n/data/', train=False, download=True,
